...
(function () {
  var robot_select = document.querySelectorAll('.robot-select');

  for (var i = 0; i < robot_select.length; i++) {
    robot_select[i].addEventListener('change', function () {
      if (document.querySelectorAll('.robot-select:checked').length === 2) {
        var not_checked_input = document.querySelectorAll('.robot-select:not(:checked)');

        for (var k = 0; k < not_checked_input.length; k++) {
          not_checked_input[k].disabled = true;
        }

        document.querySelector('#start_fight').disabled = false;
      } else {
        var input = document.querySelectorAll('.robot-select');

        for (var _k = 0; _k < input.length; _k++) {
          input[_k].disabled = false;
        }
      }
    });
  }
  ...
  if (document.querySelector('#start_fight') !== null) {
    document.querySelector('#start_fight').addEventListener('click', function () {
      ...
      var checked_input = document.querySelectorAll('.robot-select:checked');

      for (var _i = 0; _i < checked_input.length; _i++) {
        formdata.append('robots[]', checked_input[_i].dataset.robot);
      }
      ...
      fetch('/fight', {
        ...
        var winner_html = "<h5>Győztes adatai</h5>";
        winner_html += "<p>";
